...
const ManageJobs = () => {
  ...
  // Safe calculations
  const activeJobsCount = Array.isArray(jobs) ? jobs.filter(job => job.visible).length : 0;
  const totalApplicants = Array.isArray(jobs) ? jobs.reduce((sum, job) => sum + job.applicants, 0) : 0;
            ...
            <table className="w-full text-primary">
              <thead className="bg-gray-50 border-b">
                <tr>
                  ...
                  <th className="py-4 px-6 text-left max-sm:hidden sm:text-[16px] font-semibold">Date</th>
                  <th className="py-4 px-6 text-left max-sm:hidden sm:text-[16px] font-semibold">Location</th>
