      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <motion.div variants={itemVariants}>
              <div className="mb-6">
                <div className="flex items-center">
                  ...
                  <h3 className="text-2xl font-bold text-white">Job Hub</h3>
                </div>
        ...
        >
          <div className="flex space-x-4">
            ...
            <a href="https://github.com/Naserian26" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center group hover:bg-blue-600 transition-all duration-300">
            ...
            <a href="https://www.instagram.com/n_a.s.e.r.i.a.n?igsh=MWUxOGYyNG1ybHZueQ==" className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center group hover:bg-blue-600 transition-all duration-300">
              <svg className="w-5 h-5 text-gray-400 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        >
          <div className="flex items-center mb-4 md:mb-0">
            ...
            <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent font-bold text-xl">Job Hub</span>
          </div>
